...
pub use datetime_funcs::{
    ...
    SparkDateTrunc, SparkHour, SparkHoursTransform, SparkMakeDate, SparkMakeTime,
    SparkMakeTimestamp, SparkMinute, SparkNextDay, SparkSecond, SparkSecondsToTimestamp,
